...
public class Level21 : PlayableLevel
{
    bool updated;
    bool moveAtStart;
    public override void Initialize()
    {
        ...
        _levelActions.Add(new LevelAction(6, 11.5f, ActionTypes.AddEnemy));
        _levelActions.Add(new LevelAction(6, 12f, ActionTypes.AddEnemy));
        _levelActions.Add(new LevelAction(6, 14f, ActionTypes.AddEnemy));
        _levelActions.Add(new LevelAction(6, 15f, ActionTypes.AddEnemy));
        _levelActions.Add(new LevelAction(6, 17f, ActionTypes.AddEnemy));
